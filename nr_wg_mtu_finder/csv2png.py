...
def create_heatmap_from_log(log_filepath, heatmap_filepath):
    ...
    f.suptitle("Peer MTU vs Server MTU Bandwidth (Mbps)", fontsize=16)
...
log_filepath = argv[1]
heatmap_filepath = f"heatmap_{argv[1]}.png"
create_heatmap_from_log(log_filepath, heatmap_filepath)
